...
public class SimplePageRankComputation2 extends BasicComputation<LongWritable,
    DoubleWritable, DoubleWritable, DoubleWritable> {
  /** Number of supersteps for this test */
  public static final int MAX_SUPERSTEPS = 30;
  /** Logger */
  private static final Logger LOG =
      Logger.getLogger(SimplePageRankComputation2.class);
  /** Sum aggregator name */
...
*/
  ...
  /**
* Simple VertexReader that supports {@link SimplePageRankComputation2}
*/
  public static class SimplePageRankVertexReader extends
      GeneratedVertexReader<LongWritable, DoubleWritable, DoubleWritable> {
    /** Class logger */
    private static final Logger LOG =
  ...
  /**
* Simple VertexInputFormat that supports {@link SimplePageRankComputation2}
*/
  public static class SimplePageRankVertexInputFormat extends
    GeneratedVertexInputFormat<LongWritable, DoubleWritable, DoubleWritable> {
    @Override
  ...
  /**
* Simple VertexOutputFormat that supports {@link SimplePageRankComputation2}
*/
  public static class SimplePageRankVertexOutputFormat extends
    ...
    /**
* Simple VertexWriter that supports {@link SimplePageRankComputation2}
*/
